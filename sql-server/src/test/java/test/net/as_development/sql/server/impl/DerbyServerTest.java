...
import net.as_development.sql.server.impl.EmbeddedDerbyServer;
...
public class DerbyServerTest
{
     ...
     */
    @Test
    public void testForDefaults ()
        throws Exception
    {
        EmbeddedDerbyServer aServer = new EmbeddedDerbyServer ();
