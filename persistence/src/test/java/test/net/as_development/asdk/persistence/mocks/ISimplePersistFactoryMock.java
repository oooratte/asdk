 ...
 */
public class ISimplePersistFactoryMock
{
	//-------------------------------------------------------------------------
	private ISimplePersistFactoryMock ()
	     throws Exception
	{}

	//-------------------------------------------------------------------------
	public static ISimplePersistence get (final String    sImplClass,
										  final String... lConfig   )
		throws Exception
	{
		final ISimplePersistence iPersist = ISimplePersistTransactedMock.createFullFunctionalMock(new HashMap< String, Object >());
		return iPersist;
	}
}
