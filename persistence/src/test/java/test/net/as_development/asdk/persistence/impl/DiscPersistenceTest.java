...
public class DiscPersistenceTest
{
		...
		throws Exception
	{
		...
		aDisc.configure(ISimplePersistence.CFG_PERSISTENCE_SCOPE, "test-disc-persistence-initial-empty");
	...
	{
		final DiscPersistence aDisc = new DiscPersistence ();
		aDisc.configure(ISimplePersistence.CFG_PERSISTENCE_SCOPE, "test-disc-persistence-set-get-commit");

		aDisc.set("1", "value-01");
		aDisc.set("2", "value-02");
	...
	//-------------------------------------------------------------------------
	@Test
	public void testSetGetRollback()
		throws Exception
	{
		final DiscPersistence aDisc = new DiscPersistence ();
		aDisc.configure(ISimplePersistence.CFG_PERSISTENCE_SCOPE, "test-disc-persistence-set-get-rollback");
		...
		Assert.assertNull ("testSetGetRollback [01] unexpected value", aDisc.get("1"));
		Assert.assertNull ("testSetGetRollback [02] unexpected value", aDisc.get("2"));
	}
}
